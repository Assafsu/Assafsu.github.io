		...
		function getLayout(params)
		{
			...
			{//Show the starting stimuli with the instructions' layout.
				layout = layout.concat([				
					...
					{location:{top:5 + 2 + (params.focalCatTitle.height | 3) + (params.focalCatTitle.startStimulus.height | 3)}, 
					media : params.focalAttTitle.media, css: params.focalAttTitle.css},
					{location:{top:5 + 2 + (params.focalCatTitle.height | 3) + (params.focalCatTitle.startStimulus.height | 3) + (params.focalAttTitle.height | 3)}, 
