		...
		function getLayout(params)
		{
			...
			{//Show the starting stimuli with the instructions' layout.
				layout = layout.concat([				
					...
					{location:{top:5 + (params.focalCatTitle.height | 4) + (params.focalCatTitle.startStimulus.height | 5)},
						media:{word:'וגם'}, css:{color:'#000000','font-size':'1.8em'}}, 
					{location:{top:5 + 1 + (params.focalCatTitle.height | 4) + (params.focalCatTitle.startStimulus.height | 5)}, 
			...
			{
				layout = layout.concat([
					{location:{top:5+ (params.focalCatTitle.height | 2)}, 
						media:{word:'וגם'}, css:{color:'#000000','font-size':'1.8em'}}, 
