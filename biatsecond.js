	...
	**/
	...
	function iatExtension(options)
	{
		...
		var batObj = 
		{
			...
			'<p>לחצו על המקש האחר כדי להמשיך. I אם לחצתם על E וסומנה שגיאה הקישו<br/><p/>',	
			'<p>E אם לחצתם על I וסומנה שגיאה הקישו על<p/>',
			...
			leftKeyText : 'לכל השאר, מקש "E" ', 
			rightKeyText : 'אם הפריט שייך, מקש "I"', 
			...
			instTemplate: '<div><p align="center" style="font-size:20px; font-family:arial"><br/>' +
				...
				'<p style="font-size:20px; text-align:right; vertical-align:bottom; margin-right:10px; font-family:arial">' +
