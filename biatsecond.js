		...
		function getLayout(params)
		{
			...
			{//Show the starting stimuli with the instructions' layout.
				layout = layout.concat([				
					...
					{location:{top:5 + 1 + (params.focalCatTitle.height | 1) + (params.focalCatTitle.startStimulus.height | 1)}, 
					media : params.focalAttTitle.media, css: params.focalAttTitle.css},
					{location:{top:5 + 1 + (params.focalCatTitle.height | 1) + (params.focalCatTitle.startStimulus.height | 1) + (params.focalAttTitle.height | 1)}, 
