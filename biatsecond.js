		...
		function getLayout(params)
		{
			...
			{//Show the starting stimuli with the instructions' layout.
				layout = layout.concat([				
					...
					{location:{top:1 + (params.focalCatTitle.height | 6) + (params.focalCatTitle.startStimulus.height | 5)},
						media:{word:'וגם'}, css:{color:'#000000','font-size':'1.8em'}}, 
					{location:{top:5 + 1 + (params.focalCatTitle.height | 7) + (params.focalCatTitle.startStimulus.height | 6)}, 
					media : params.focalAttTitle.media, css: params.focalAttTitle.css},
					{location:{top:5 + 1 + (params.focalCatTitle.height | 7) + (params.focalCatTitle.startStimulus.height | 3) + (params.focalAttTitle.height | 8)}, 
			...
			else
			{
				layout = layout.concat([
					{location:{top:1+ (params.focalCatTitle.height | 1)}, 
						media:{word:'וגם'}, css:{color:'#000000','font-size':'1.8em'}}, 
					{location:{top:1 + (params.focalCatTitle.height | 4)}, 
					media : params.focalAttTitle.media, css: params.focalAttTitle.css}
				]); 
			}
